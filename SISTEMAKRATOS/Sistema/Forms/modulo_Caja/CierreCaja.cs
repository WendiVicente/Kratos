...
namespace Sistema.Forms.modulo_Caja
{
    ...
    {
        private ModuloCaja _cajaIniciofrm = null;
        ...
        public CierreCaja(ModuloCaja cajaInicio, Caja cajaactiva)
        {
        ...
        private void cargarDGVcheques()
        {
            ...
            var listaFiltroCheque = obtenerDetalle.Where(x => x.Cheques > 0).ToList();
            BindingSource source = new BindingSource();
            source.DataSource = listaFiltroCheque;
            dgvIngresosCheque.DataSource = typeof(List<>);
            dgvIngresosCheque.DataSource = source;
            dgvIngresosCheque.AutoResizeColumns();
            dgvIngresosCheque.Columns[0].Visible = false;
            dgvIngresosCheque.Columns[1].Visible = false;
            dgvIngresosCheque.Columns[5].Visible = false;
            dgvIngresosCheque.Columns[7].Visible = false;
            dgvIngresosCheque.Columns[8].Visible = false;
            dgvIngresosCheque.Columns[9].Visible = false;
            dgvIngresosCheque.Columns[10].Visible = false;
        ...
        private void cargarDGVTarjeta()
        {
            ...
            dgvIngresoTarjeta.Columns[0].Visible = false;
            dgvIngresoTarjeta.Columns[1].Visible = false;
            dgvIngresoTarjeta.Columns[5].Visible = false;
            dgvIngresoTarjeta.Columns[6].Visible = false;
            dgvIngresoTarjeta.Columns[9].Visible = false;
            dgvIngresoTarjeta.Columns[10].Visible = false;

        }
        private void cargarDGVOtrosingr()
        {
            var obtenerDetalle = _cajasRepository.GetDetalleCaja(_cajaToclose.Id);
            var listaFiltroTarjetas = obtenerDetalle.Where(x => x.Transferencias > 0 ).ToList();
            BindingSource source = new BindingSource();
            source.DataSource = listaFiltroTarjetas;
            dgvIngresoOtros.DataSource = typeof(List<>);
            dgvIngresoOtros.DataSource = source;
            dgvIngresoOtros.AutoResizeColumns();
            dgvIngresoOtros.Columns[0].Visible = false;
            dgvIngresoOtros.Columns[1].Visible = false;
            dgvIngresoOtros.Columns[5].Visible = false;
            dgvIngresoOtros.Columns[6].Visible = false;
            dgvIngresoOtros.Columns[7].Visible = false;
            dgvIngresoOtros.Columns[8].Visible = false;
            dgvIngresoOtros.Columns[9].Visible = false;
        }
        ...
        public void CerrarCaja()
        {
            ...
            if (operacionesBasic() < 0)
            {
                ...
                _cajaIniciofrm.DgvCajaActual.DataSource = null;
        ...
        {
            var filaselected = (ListarCajaDetalles)dgvIngresosCheque.CurrentRow.DataBoundItem;
            TraerDetalleCheque(filaselected);
        }
        ...
        private void dgvIngresoTarjeta_CellClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           // cargarDGVTarjeta(dgvIngresoTarjeta, traerlistadetalle);
        }

        private void dgvIngresoOtros_CellClick(object sender, DataGridViewCellEventArgs e)
        {
           // var traerlistadetalle = _facturasRepository.GetDetallebyFactura((Guid)filaSelected.FacturaId);
          //  cargarDGVTarjeta(dgvDetalleCheques, traerlistadetalle);
        }

        private void TraerDetalleCheque(ListarCajaDetalles filaSelected)
        {
