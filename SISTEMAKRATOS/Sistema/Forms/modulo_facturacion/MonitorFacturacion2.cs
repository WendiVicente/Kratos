...
{
    public partial class MonitorFacturacion2 : BaseContext
    {
        #region VARIABLES
        ...
        public MonitorFacturacion2(User user, Form formBack)
        {
        ...
        private void MonitorFacturacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void CargarSolicitudesContado(List<ListaFacturacion> listado)
        {
            ...
            var solicitudes = new SolicitudesRepository(_context).GetSolicitudes(UsuarioLogeadoSistemas.User.SucursalId);
        ...
        private void CargarSolicitudesCredito(List<ListaFacturacion> listado)
        {
            ...
            //22 -> vale
            ListaFacturacion documento = new ListaFacturacion();
            solicitudes = _solicitudesRepository.GetSolicitudes(UsuarioLogeadoSistemas.User.SucursalId);
        ...
        {
            ListaFacturacion documento = new ListaFacturacion();
            vales = _valesRepository.GetListaVales(UsuarioLogeadoSistemas.User.SucursalId);
            //if (vales.Count() > 0)
            //{
        ...
        private void Cobro(List<ListaFacturacion> listado)
        {
            ...
            {
                Cobro2 sel = new Cobro2(listado, this);
                sel.Show();
            }
            else
            {
        ...
        private void BtnFacturarVarios_Click(object sender, EventArgs e)
        {
            CobrarPedidos();
        }
        ...
        private void EvaluarExistenciasParaCobro(List<ListaFacturacion> listado)
        {
            ...
            //List<object> detalles = ExistenciasDetalle(listado);
        ...
        public void RefrescarDataGridCert(List<DocumentoCertificadoSAT> lista, bool loadNewContext = true)
        {
            ...
            DgvCertificados.ClearSelection();
        }
                

        private void TxtBuscadorCert_TextChanged(object sender, EventArgs e)
        {

        }

        private void BtnRefrescarCert_Click(object sender, EventArgs e)
        {
            RefrescarDataGridCert(_listaDocumentos);
        }

        private void BtnAnularCert_Click(object sender, EventArgs e)
        {

        }

        private void BtnOrdenarCert_Click(object sender, EventArgs e)
        {
            BindingSource source = new BindingSource();
            source.DataSource = _listaDocumentos.OrderByDescending(x => x.Fecha_DTE);
            DgvCertificados.DataSource = source;
            DgvCertificados.ClearSelection();
        }
        ...
        public void CargarListaNotasCredito(bool loadNewContext = true, int valor = 0) // 0 es por defecto
        {
            if (loadNewContext)
            {
                _context = null;
        ...
        private void TxtBuscadorNC_TextChanged(object sender, EventArgs e)
        {

        }

        private void BtnActualizarNC_Click(object sender, EventArgs e)
        {
            CargarListaNotasCredito(true);
        }

        private void BtnOrdenarNC_Click(object sender, EventArgs e)
        {

        }

        private void BtnNuevaNC_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms["ModuloNotaCredito"] == null)
            {
                ModuloNotaCredito notacredito = new ModuloNotaCredito();
                notacredito.Show();
            }
            else
            {
                Application.OpenForms["ModuloNotaCredito"].Activate();
            }
        }

        private void BtnValidarNotaC_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Esta nota de crédito ya fue cobrada, elija otra para continuar..");
            }
        }
        ...
        public void CargarNotasDebito(bool loadNewContext = true, int valor = 0)
        {
            if (loadNewContext)
            {
                _context = null;
            ...
            DgvNotasDebito.ClearSelection();
        }

        private void TxtBuscadorND_TextChanged(object sender, EventArgs e)
        {

        }

        private void BtnActualizarND_Click(object sender, EventArgs e)
        {
            CargarNotasDebito(true);
        }

        private void BtnOrdenarND_Click(object sender, EventArgs e)
        {

        }

        private void BtnNuevaND_Click(object sender, EventArgs e)
        {
            toolSeleccionarVenta.Visible = true;
            dataGridView1.Visible = true;
        }

        private void BtnValidarNotaD_Click(object sender, EventArgs e)
        {
